...
if ("valid".equals(msg))
{%>
<center><font colour="red" size="5">Successfully Updated</font></center>
<%
}
%>
<%
...
{%>
<center><font colour="red" size="5">Some thing went wrong! Try Again!</font></center>
<%
}
%>
<%
...
{%>
<center><font colour="red" size="5">Successfully Deleted</font></center>
<%
}
%>
